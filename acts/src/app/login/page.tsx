          ...
          {chat?.sso && (
            <div className="mb-6 flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-muted-foreground max-w-md text-center">
                ...
                Роль (тестировщик / старший / начальник) берётся из вашей роли в группе чата.
                Не состоите в группе — попросите начальника добавить. Или выберите себя ниже и войдите по PIN.
              </p>
            </div>
          )}
